          ...
          <TooltipTrigger
            render={
              <a
                ...
                className="flex size-9 items-center justify-center rounded-lg border border-border text-muted-foreground transition-all hover:scale-110 hover:border-primary/40 hover:bg-accent hover:text-foreground motion-reduce:hover:scale-100"
              />
            }
          >
            <svg
